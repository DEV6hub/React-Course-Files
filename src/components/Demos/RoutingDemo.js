...
export default class RoutingDemo extends React.Component {
  ...
  render1(title) {
    ...
    // return (<Router><div>
    //     <Route path="/user" component={ <User username="Bob"/> } />
    // </div></Router>);
    ...
    // return (<Router><div>
    //     {this.buttons()}
    //     <Route path="/user" render={ () => (<User2 username={this.state.username} /> ) } />
    // </div></Router>);
    ...
    return (
      <Router>
        <div>
          ...
          <Link to="/params/bob">part 2</Link> {' | '}
      ...
      <Router>
        <div>
          ...
          {/*             
            <Route 
                path="/here" 
                children={ ({match, location}) => (<div style={{border: '1px solid black'}}>
                    <p><code>Route.path</code>: /here.</p>
                    <p><code>location.pathname</code>: {location.pathname}</p>
                    {!match && <p><code>Route.path != location.pathname</code> so...</p>}
                    {match && <p><code>Route.path == location.pathname</code> so...</p>}
                    {
                        !match 
                        ? <p><code>match</code>: null</p>  
                        : <p><code>match.path</code>: NOT null ({match.path})</p>
                    }    
                    <p>The <code>children</code> function always executes and returns <em>something</em>, even when <code>match</code> is null.</p>
                </div>)}
            />
            */}
